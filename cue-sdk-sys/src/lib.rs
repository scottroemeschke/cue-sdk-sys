...
pub const CorsairChannelDeviceType_CCDT_WaterBlock: CorsairChannelDeviceType = 9;
pub const CorsairChannelDeviceType_CCDT_SPPRO_Fan: CorsairChannelDeviceType = 10;
